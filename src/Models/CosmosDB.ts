...
export class CosmosDB implements Component, Provisionable {
  ...
  async provision(): Promise<boolean> {
    ...
    if (!cosmosDbNameChoose.description) {
      ...
      channelShowAndAppendLine(
        this.channel,
        JSON.stringify(cosmosDBDeploy, null, 4)
      );
      ...
      if (cosmosDbDetail) {
        channelShowAndAppendLine(
          this.channel,
          JSON.stringify(cosmosDbDetail, null, 4)
        );
      }
  ...
  private async getCosmosDbInResourceGroup() {
    const resource = `/subscriptions/${AzureUtility.subscriptionId}/resourceGroups/${AzureUtility.resourceGroup}/providers/Microsoft.DocumentDB/databaseAccounts?api-version=2015-04-08`;
  ...
  private async getCosmosDbKey(name: string) {
    const resource = `/subscriptions/${AzureUtility.subscriptionId}/resourceGroups/${AzureUtility.resourceGroup}/providers/Microsoft.DocumentDB/databaseAccounts/${name}/listKeys?api-version=2015-04-08`;
